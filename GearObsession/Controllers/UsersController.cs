...
namespace GearObsession.Controllers
{
  public class UsersController : Controller
  {
    ...
    public ActionResult Details(int id)
    {
      ...
      //testDict will be generated by a method
      Dictionary<string, int> testDict  = new Dictionary<string,int> {{"Sleeping Bag", 5}, {"Water Bottle", 3},{"Tent", 20}};
      ViewBag.testDict = testDict;
